<template>
  <section class="about section-padding">
    ...
    <div class="bg-img pat valign text-center" style="background-image:url('/img/pat1.png')">
    ...
    <ModalVideo :channel="about.video.channel" :videoId="about.video.id" :isOpen.sync="videoIsOpen" :onClose="onClose" />
  </section>
</template>
...
//= Static Data
import about from "@/data/home3-light-about.json";
